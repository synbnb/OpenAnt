(() => {
  ...
  class OpenAntWorkspaceNav extends HTMLElement {
    connectedCallback() {
      this.render();
    ...
    render() {
      ...
      nav.setAttribute("aria-label", lang === "en" ? "OpenAnt workspaces" : "OpenAnt 工作台导航");
  ...
  if (!customElements.get("openant-workspace-nav")) {
    customElements.define("openant-workspace-nav", OpenAntWorkspaceNav);
  }
})();
