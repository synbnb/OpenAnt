// Package cmd implements the Cobra CLI commands for VulnFounder.
package cmd
...
var rootCmd = &cobra.Command{
	...
	Long: `VulnFounder is a two-stage SAST tool that uses LLM-assisted evidence analysis
...
func requireAPIKey() string {
	...
	fmt.Fprintln(os.Stderr, "Run:  vulnfounder set-api-key <your-anthropic-api-key>")
	fmt.Fprintln(os.Stderr, "")
	fmt.Fprintln(os.Stderr, "Or author an `llm_providers` section in VULNFOUNDER_CONFIG_FILE, project-local config/vulnfounder/config.json, or a legacy VulnFounder config")
