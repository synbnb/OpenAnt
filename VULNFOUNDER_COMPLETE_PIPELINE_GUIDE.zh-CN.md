# VulnFounder 完整扫描主流程学习笔记

本文用于回看 VulnFounder 从接收仓库路径到生成最终扫描结果的完整流程，重点说明每个阶段的输入、处理方式、输出文件，以及哪些地方会调用大模型。

本文对应的核心实现位于 `libs/vulnfounder-core`。VulnFounder 还包含 Go CLI 层；Go CLI 主要负责命令行、项目目录和跨语言 JSON 契约，核心分析流程由 Python 实现。
...
- [`apps/vulnfounder-cli/cmd/scan.go`](apps/vulnfounder-cli/cmd/scan.go)
- [`libs/vulnfounder-core/core/scanner.py`](libs/vulnfounder-core/core/scanner.py)
...
阶段报告由 [`libs/vulnfounder-core/core/step_report.py`](libs/vulnfounder-core/core/step_report.py) 的 `step_context()` 自动记录。每个阶段通常会生成一个：
...
- [`libs/vulnfounder-core/core/parser_adapter.py`](libs/vulnfounder-core/core/parser_adapter.py)
- `libs/vulnfounder-core/parsers/<language>/repository_scanner.py`
- `libs/vulnfounder-core/parsers/<language>/call_graph_builder.py`
...
VulnFounder 不只是把一个函数单独交给后续阶段，而是为目标函数拼装一个分析单元。
...
- [`libs/vulnfounder-core/utilities/agentic_enhancer/entry_point_detector.py`](libs/vulnfounder-core/utilities/agentic_enhancer/entry_point_detector.py)
- [`libs/vulnfounder-core/core/parser_adapter.py`](libs/vulnfounder-core/core/parser_adapter.py)
...
- [`libs/vulnfounder-core/utilities/agentic_enhancer/reachability_analyzer.py`](libs/vulnfounder-core/utilities/agentic_enhancer/reachability_analyzer.py)
- [`libs/vulnfounder-core/core/parser_adapter.py`](libs/vulnfounder-core/core/parser_adapter.py)
...
- [`libs/vulnfounder-core/context/application_context.py`](libs/vulnfounder-core/context/application_context.py)
- [`libs/vulnfounder-core/context/threat_model.py`](libs/vulnfounder-core/context/threat_model.py)
...
实现：[`libs/vulnfounder-core/core/llm_reachability.py`](libs/vulnfounder-core/core/llm_reachability.py)。默认通常关闭。
...
- [`libs/vulnfounder-core/core/enhancer.py`](libs/vulnfounder-core/core/enhancer.py)
- [`libs/vulnfounder-core/utilities/agentic_enhancer/agent.py`](libs/vulnfounder-core/utilities/agentic_enhancer/agent.py)
- [`libs/vulnfounder-core/utilities/agentic_enhancer/tools.py`](libs/vulnfounder-core/utilities/agentic_enhancer/tools.py)
...
Prompt 位置：[`libs/vulnfounder-core/prompts/vulnerability_analysis.py`](libs/vulnfounder-core/prompts/vulnerability_analysis.py)。
...
- [`libs/vulnfounder-core/core/analyzer.py`](libs/vulnfounder-core/core/analyzer.py)
- [`libs/vulnfounder-core/prompts/vulnerability_analysis.py`](libs/vulnfounder-core/prompts/vulnerability_analysis.py)
...
- [`libs/vulnfounder-core/core/verifier.py`](libs/vulnfounder-core/core/verifier.py)
- [`libs/vulnfounder-core/utilities/finding_verifier.py`](libs/vulnfounder-core/utilities/finding_verifier.py)
- [`libs/vulnfounder-core/prompts/verification_prompts.py`](libs/vulnfounder-core/prompts/verification_prompts.py)

## 13. 构建 `pipeline_output.json`

这是一个确定性的 Python 转换步骤，不调用大模型。

函数位置：[`libs/vulnfounder-core/core/reporter.py`](libs/vulnfounder-core/core/reporter.py) 中的 `build_pipeline_output()`。
...
定义在：[`libs/vulnfounder-core/core/verdict_taxonomy.py`](libs/vulnfounder-core/core/verdict_taxonomy.py) 的 `DYNAMIC_TESTABLE`。
...
VulnFounder 会检查 JSON、必需字段和字符串类型。不合法时不会执行 Docker。
...
- [`libs/vulnfounder-core/core/dynamic_tester.py`](libs/vulnfounder-core/core/dynamic_tester.py)
- [`libs/vulnfounder-core/utilities/dynamic_tester/__init__.py`](libs/vulnfounder-core/utilities/dynamic_tester/__init__.py)
- [`libs/vulnfounder-core/utilities/dynamic_tester/docker_executor.py`](libs/vulnfounder-core/utilities/dynamic_tester/docker_executor.py)
...
- [`libs/vulnfounder-core/core/reporter.py`](libs/vulnfounder-core/core/reporter.py)
- [`libs/vulnfounder-core/report/generator.py`](libs/vulnfounder-core/report/generator.py)
- [`libs/vulnfounder-core/report/prompts/disclosure.txt`](libs/vulnfounder-core/report/prompts/disclosure.txt)
