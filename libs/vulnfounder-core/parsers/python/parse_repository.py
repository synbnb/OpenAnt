...
datasets for VulnFounder's vulnerability analysis. It orchestrates a
4-stage pipeline:
...
def generate_analyzer_output(extractor_result: dict, call_graph_result: dict | None = None) -> dict:
    ...
    This format is compatible with VulnFounder's RepositoryIndex class,
...
def parse_repository(repo_path: str, options: dict = None) -> tuple:
    ...
    Returns:
        Tuple of (dataset, analyzer_output):
            - dataset: Dictionary compatible with VulnFounder experiment.py
