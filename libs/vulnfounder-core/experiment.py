#!/usr/bin/env python3
"""
VulnFounder Experiment Runner - Two-Stage Vulnerability Analysis
...
_TEST_REPOS = (
    os.environ.get("VULNFOUNDER_TEST_REPOS", "").strip()
    or os.environ.get("OPENANT_TEST_REPOS", "").strip()
...
def main():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "VULNFOUNDER_CONFIG_FILE (or legacy OPENANT_CONFIG_FILE), "
            "project-local config/vulnfounder/config.json (or legacy config/openant/config.json), "
