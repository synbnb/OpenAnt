"""
Output schemas for VulnFounder CLI.
...
@dataclass
class ScanResult:
    """Result of `vulnfounder scan` (all-in-one)."""
    output_dir: str
...
class DynamicTestStepResult:
    """Result of `vulnfounder dynamic-test`."""
