...
* **Attribution headers.** ``HTTP-Referer`` / ``X-Title`` identify
  VulnFounder in OpenRouter's rankings, per their attribution docs.
...
_ATTRIBUTION_HEADERS = {
    "HTTP-Referer": "https://github.com/knostic/VulnFounder",
    "X-Title": "VulnFounder",
}
...
class OpenRouterAdapter:
    ...
    def __init__(
        ...
        *,
        ...
        raw_retries = first_env("VULNFOUNDER_OPENAI_MAX_RETRIES", "OPENANT_OPENAI_MAX_RETRIES")
        ...
        raw_timeout = first_env("VULNFOUNDER_OPENAI_REQUEST_TIMEOUT_SECONDS", "OPENANT_OPENAI_REQUEST_TIMEOUT_SECONDS")
        if raw_timeout:
            try:
